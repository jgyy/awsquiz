...
export const videoCatalog: VideoEntry[] = [
  ...
  { id: "bJCmZn9fASM", label: "7 Rs Migration Strategies and AWS Migration Services", keywords: ["migration", "migrate", "migrating", "replatform", "refactor", "repurchase", "retire", "retain", "relocate", "7 rs", "six rs", "seven rs", "migration evaluator", "migration strategy", "migration strategies"] },
  ...
  { id: "_ZCTvmaPgao", label: "AWS IAM Core Concepts You NEED to Know", keywords: ["iam", "identity and access management", "least privilege", "permissions", "principal", "authentication", "authorization"] },
  { id: "DgTLq1NfJI4", label: "IAM Roles vs Users vs Groups", keywords: ["iam role", "iam roles", "iam user", "iam users", "iam group", "iam groups", "access key", "access keys", "temporary credentials", "sts", "assume role", "cross-account"] },
  ...
  // Storage
  { id: "R0fqpQd9mSM", label: "Amazon S3 Explained in 10 Minutes", keywords: ["s3", "simple storage service", "bucket", "buckets", "object storage", "durability", "11 nines", "unlimited storage", "objects"] },
  ...
  { id: "NNpIbip8nGE", label: "AWS Backup Tutorial for Beginners", keywords: ["aws backup", "backup plan", "backup plans", "backups", "backup vault", "centralized backup", "centrally manage backups"] },
  ...
  { id: "RoKAEzdcr7k", label: "SQS vs SNS vs EventBridge: When to Use What", keywords: ["decouple", "decoupling", "decoupled", "loosely coupled", "message", "messages", "messaging", "mq", "amazon mq", "activemq", "rabbitmq", "sqs vs sns"] },
  ...
  { id: "kAaPjE9-a2A", label: "Amazon S3: Cross-Region Replication and Versioning (AWS)", keywords: ["versioning", "cross-region replication", "replication", "object lock", "accidental deletion", "accidentally deleted", "previous version", "previous versions", "overwritten", "mfa delete"] },
  ...
  { id: "jo3X_aay4Vs", label: "Keep Your Network Traffic in AWS with VPC Endpoints", keywords: ["vpc endpoint", "vpc endpoints", "privatelink", "gateway endpoint", "interface endpoint", "without traversing", "public internet", "privately connect", "private connectivity"] },
