...
export const cloudTechnologyAndServicesQuestions: Question[] = [
  ...
  },
  {
    id: "tech113",
    domain: "cloud-technology-and-services",
    text: "A utility company collects readings from millions of smart meters every minute and needs to store and query this time-stamped data efficiently, automatically moving recent data in a memory tier to a cheaper magnetic tier as it ages. Which purpose-built AWS database should it choose?",
    options: [
      { id: "a", text: "Amazon Timestream" },
      { id: "b", text: "Amazon Neptune" },
      { id: "c", text: "Amazon QLDB" },
      { id: "d", text: "Amazon DocumentDB" },
    ],
    correctOptionIds: ["a"],
    explanation: "Amazon Timestream is a serverless time series database built for IoT and operational telemetry. It manages data lifecycle across memory and magnetic storage tiers and offers built-in time series analytics functions.",
    optionRationale: {
      a: "Timestream is purpose-built for time series data such as sensor readings and includes tiered storage and retention policies.",
      b: "Neptune is a graph database for highly connected data such as social networks.",
      c: "QLDB is an immutable ledger database for verifiable transaction history, not high-volume telemetry.",
    ...
    referenceLabel: "What is Amazon Timestream?",
    consoleUrl: "https://console.aws.amazon.com/timestream/home#databases",
    consoleLabel: "Timestream > Databases",
    diagram: "flowchart LR\n  Meters[Smart meters] --> IoT[AWS IoT Core]\n  IoT --> TS[Timestream table]\n  TS --> Mem[Memory store recent data]\n  Mem -->|retention policy| Mag[Magnetic store historical data]",
    cliExample: {
      description: "List Timestream databases in the Region",
      command: "aws timestream-write list-databases",
      sampleOutput: "{\n  \"Databases\": [\n    {\n      \"Arn\": \"arn:aws:timestream:us-east-1:123456789012:database/meter-readings\",\n      \"DatabaseName\": \"meter-readings\",\n      \"TableCount\": 2,\n      \"CreationTime\": \"2026-03-01T08:15:00+00:00\"\n    }\n  ]\n}",
    },
  },
  {
    id: "tech114",
    domain: "cloud-technology-and-services",
    text: "A bank must record every change to customer account balances in a way that is immutable and cryptographically verifiable, so auditors can prove that no historical entry was altered. The bank does not want to run its own blockchain network. Which AWS service best meets this requirement?",
    options: [
    ...
    correctOptionIds: ["a"],
    explanation: "Amazon QLDB is a fully managed ledger database that provides a transparent, immutable, and cryptographically verifiable transaction log owned by a central trusted authority, without the overhead of a decentralized blockchain network.",
    optionRationale: {
      a: "QLDB maintains a complete, immutable journal of changes that can be verified with a cryptographic hash chain.",
      b: "RDS is a general-purpose relational database; records can be updated or deleted unless extra controls are built.",
      c: "DynamoDB is a NoSQL key-value store without a built-in immutable, verifiable history.",
      d: "Managed Blockchain is for decentralized networks with multiple parties; the bank wants a single trusted authority.",
    },
    referenceUrl: "https://docs.aws.amazon.com/qldb/latest/developerguide/what-is.html",
    referenceLabel: "What is Amazon QLDB?",
    consoleUrl: "https://console.aws.amazon.com/qldb/home#ledgers",
    consoleLabel: "QLDB > Ledgers",
    diagram: "flowchart LR\n  App[Banking application] --> Ledger[QLDB ledger]\n  Ledger --> Journal[Immutable journal hash chain]\n  Auditor --> Journal\n  Journal -->|verify digest| Auditor",
    cliExample: {
      description: "Describe a QLDB ledger",
      command: "aws qldb describe-ledger --name account-ledger",
      sampleOutput: "{\n  \"Name\": \"account-ledger\",\n  \"Arn\": \"arn:aws:qldb:us-east-1:123456789012:ledger/account-ledger\",\n  \"State\": \"ACTIVE\",\n  \"CreationDateTime\": \"2026-02-10T09:00:00+00:00\",\n  \"PermissionsMode\": \"STANDARD\",\n  \"DeletionProtection\": true\n}",
    },
  },
  {
    id: "tech115",
  ...
  },
  {
    id: "tech126",
    domain: "cloud-technology-and-services",
    text: "A distributed team of developers wants a browser-based integrated development environment (IDE) that comes preinstalled with the AWS CLI and popular language runtimes, so they can write, run, and debug code from any laptop without installing tools locally. Which AWS service provides this?",
    options: [
    ...
    correctOptionIds: ["a"],
    explanation: "AWS Cloud9 is a cloud-based IDE that runs in a browser and includes a code editor, debugger, terminal, and preconfigured tools for popular languages and the AWS CLI.",
    optionRationale: {
      a: "Cloud9 delivers a full IDE experience in the browser backed by an EC2 or on-premises environment.",
      b: "CodeBuild compiles and tests code as part of a pipeline; it is not an interactive IDE.",
      c: "CodeCommit is a managed Git repository service.",
      d: "CloudShell provides a browser-based shell for CLI commands but not a full IDE with editor and debugger.",
    },
    referenceUrl: "https://docs.aws.amazon.com/cloud9/latest/user-guide/welcome.html",
    referenceLabel: "What is AWS Cloud9?",
    consoleUrl: "https://console.aws.amazon.com/cloud9/home",
    consoleLabel: "Cloud9 > Environments",
    diagram: "flowchart LR\n  Dev[Developer browser] --> C9[Cloud9 IDE]\n  C9 --> Env[EC2 environment with runtimes and AWS CLI]\n  C9 --> Repo[Git repository]",
    cliExample: {
      description: "List Cloud9 environments owned by the caller",
  ...
  },
  {
    ...
    options: [
      { id: "a", text: "Amazon Fraud Detector identifies potentially fraudulent online activities such as fake account creation and payment fraud" },
    ...
    correctOptionIds: ["a", "b"],
    explanation: "Amazon Fraud Detector is a managed service that uses ML to detect online fraud, and Amazon Comprehend Medical is a HIPAA-eligible NLP service that extracts medical information from clinical notes. Both are pre-trained, API-driven services.",
    optionRationale: {
      a: "Fraud Detector builds fraud detection models from your historical data with no ML experience required.",
    ...
    consoleUrl: "https://console.aws.amazon.com/frauddetector/home#/detectors",
    consoleLabel: "Amazon Fraud Detector > Detectors",
    diagram: "flowchart LR\n  Signup[New account signup event] --> FD[Amazon Fraud Detector]\n  FD --> Score[\"Fraud score and outcome (approve, review, block)\"]\n  Note[Clinical note text] --> CM[Amazon Comprehend Medical]\n  CM --> Ent[\"Entities: conditions, medications, PHI\"]",
    cliExample: {
      description: "List Fraud Detector detectors",
      command: "aws frauddetector get-detectors --query \"detectors[].{Id:detectorId,EventType:eventTypeName}\"",
  ...
  },
  {
    ...
    optionRationale: {
      ...
      c: "CodeCommit is a Git source code repository, not a package registry.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: "d", text: "AWS IoT Core stores time-series data for years and is a replacement for Amazon Timestream" },
    ...
    optionRationale: {
      ...
      d: "IoT Core routes messages; long-term time-series storage belongs to services such as Timestream.",
      e: "Snowmobile is an exabyte-scale physical data transfer truck, not a device messaging channel.",
    },
  ...
  },
  {
    ...
    correctOptionIds: ["a"],
    explanation: "AWS Application Discovery Service collects server specifications, performance data, and network connection details from on-premises environments via agents or agentless collectors. The data feeds AWS Migration Hub to help plan and track migrations.",
    optionRationale: {
