...
export const billingPricingAndSupportQuestions: Question[] = [
  ...
  },
  {
    id: "bill37",
    domain: "billing-pricing-and-support",
    text: "A small company has a short, well-defined project: migrating a web application to AWS Elastic Beanstalk. It has no in-house AWS expertise and wants to hire an AWS Certified third-party expert on a pay-per-project basis, with the work and payment managed through AWS. Which AWS offering matches this need?",
    options: [
      { id: "a", text: "AWS IQ" },
      { id: "b", text: "AWS Enterprise Support" },
    ...
    correctOptionIds: ["a"],
    explanation: "AWS IQ connects customers with AWS Certified third-party experts and consulting firms for on-demand project work; the expert is granted temporary access, and payment is handled through the customer's AWS bill.",
    optionRationale: {
      a: "AWS IQ is the marketplace for hiring certified freelancers for project-based help, billed through AWS.",
      ...
      d: "Trusted Advisor is an automated recommendations tool.",
    },
    referenceUrl: "https://iq.aws.amazon.com/",
    referenceLabel: "AWS IQ",
    consoleUrl: "https://iq.aws.amazon.com/",
    consoleLabel: "AWS IQ",
    diagram: "flowchart LR\n  Cust[Customer posts project] --> IQ[AWS IQ]\n  IQ --> Expert[AWS Certified expert responds]\n  Expert --> Work[Work with temporary access]\n  Work --> Pay[Payment on AWS bill]",
    cliExample: {
      description: "Review IAM roles to confirm any temporary access granted to an AWS IQ expert has been removed after the project",
      command: "aws iam list-roles --query \"Roles[?contains(RoleName, 'IQ')].{Name:RoleName,Created:CreateDate}\"",
      sampleOutput: "[\n  {\n    \"Name\": \"AWSIQPermission-EbMigration\",\n    \"Created\": \"2026-09-01T09:12:44+00:00\"\n  }\n]",
    },
  },
  {
    id: "bill38",
